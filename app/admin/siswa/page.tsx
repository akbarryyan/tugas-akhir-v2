  ...
  return (
    <div className="space-y-8 overflow-x-clip">
      ...
      <div className="space-y-6">
        ...
        >
          <AdminImportPreview
            description="Header wajib: nama, nisn, dan kelas. Alternatif header seperti nama_siswa juga bisa digunakan."
            maxRowsLabel="Maksimal 500 baris dan ukuran file 2 MB"
            templateHref="/admin/import-template?type=siswa"

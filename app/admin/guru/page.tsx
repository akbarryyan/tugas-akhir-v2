  ...
  return (
    <div className="space-y-8 overflow-x-clip">
      ...
      <div className="space-y-6">
        ...
        >
          <AdminImportPreview
            description="Header wajib: nama, email, nip, dan password. Alternatif header seperti nama_guru atau password_awal juga bisa digunakan."
            maxRowsLabel="Maksimal 300 baris dan ukuran file 2 MB"
            templateHref="/admin/import-template?type=guru"
